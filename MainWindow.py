...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        fa5_icon3 = qta.icon('fa5s.eye-slash', color='white')
        self.showButton = QtWidgets.QPushButton(fa5_icon3, "", self.centralwidget)
        self.showButton.setIconSize(QtCore.QSize(30, 30))
        ...
        fa5_icon4 = qta.icon('fa5s.sliders-h', color='white')
        self.equalizerButton = QtWidgets.QPushButton(fa5_icon4, "", self.centralwidget)
        self.equalizerButton.setIconSize(QtCore.QSize(30, 30))
        ...
        fa5_icon = qta.icon('fa5s.sliders-h', color='white')
        self.equalizerButton.setIcon(fa5_icon)
        self.equalizerButton.setFlat(True)
        self.equalizerButton.setToolTip('Equalizer')
        self.equalizerButton.setIconSize(QtCore.QSize(30, 30))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # fa5_icon = qta.icon('fa5s.drum-steelpan', color='black')
        fa5_icon = qta.icon('fa5s.music', color='black')
